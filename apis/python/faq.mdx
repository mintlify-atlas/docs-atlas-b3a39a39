...
<AccordionGroup>
  ...
  <Accordion title="Which Python versions are supported?">
    PyFlink supports **Python 3.9, 3.10, 3.11, and 3.12**. Python 3.8 and earlier are not supported.

    Python 2 is not supported. Python 3.8 and earlier 3.x versions are not supported.
